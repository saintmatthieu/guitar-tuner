...
plt.legend()
for i, weight in enumerate(pdl.spectrumModelWeights):
    plt.text(pdl.spectrumModelIndices[i], pdl.spectrumModelValues[i], f"{weight}", fontsize=8, ha='center', va='bottom')
